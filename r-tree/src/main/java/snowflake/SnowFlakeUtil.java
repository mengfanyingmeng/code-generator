...
public class SnowFlakeUtil {
    ...
    // 64位 = 42位时间戳+5位dataCenterId+5位workId+12位同一毫秒内的递增的序列号
    ...
    public synchronized long nextId() {
        ...
        if (currentTimeMillis == lastTimeMillis) {
            ...
            if (sequence == 0) {
                ...
                log.warn("sequence == 0, currentTimeMillis = "+currentTimeMillis);
            }
    ...
    private long getNextMillis(long lastTimeMillis) {
        long currentTimeMillis = System.currentTimeMillis();
        //如果当前时间<=入参时间，一直将最新的时间赋给当前时间，直到当前时间>传入的时间
     ...
     * @return
     */
    public static String getRandomStr(Long id) {
    ...
    public static class MyThread extends Thread {
        public void run() {
            ...
            System.out.println("getRandomStr:"+ getRandomStr(id));
            System.out.println(Long.toBinaryString(((TIME_BIT & id) >> 22) + INIT_EPOCH));
